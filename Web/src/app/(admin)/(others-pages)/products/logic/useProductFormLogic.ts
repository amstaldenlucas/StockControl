...
import { CreateProductForm, FormSchema } from "../add/productFormSetup";
...
export function useProductFormLogic({ productId, onSuccess }: UseProductFormLogicProps): ProductFormLogic {
    ...
    const { data: groupsData } = useSWR<ProductGroup[]>("product_groups", getProductGroups);
